...
- (void)commonInit {
    ...
    self.selectionIndicatorTextWarpWith = 0;
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == HMSegmentedControlSelectionStyleTextWidthStripe &&
            ...
            return CGRectMake(x + self.selectionIndicatorEdgeInsets.left - 5 - self.selectionIndicatorTextWarpWith, indicatorYOffset, sectionWidth - self.selectionIndicatorEdgeInsets.right + 10 + (self.selectionIndicatorTextWarpWith * 2), self.selectionIndicatorHeight);
        } else {
